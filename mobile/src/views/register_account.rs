...
pub fn RegisterAccount() -> Element {
    ...
    async fn client_create_account(event: Event<FormData>, mut error_sig: Signal<Option<String>>) -> () {
        ...
        let (account_id, session_token) = create_account(
            email.to_owned(),
            username.to_owned(),
            public_key.pk,
            x3dh_public,
        ...
        div {
            ...
            div {
                ...
                div {
                    ...
                    form {
                        onsubmit: move |event| client_create_account(event, error),
                        p {
                            margin: 0,
                            margin_bottom: "8px",
                            "Email "
...
pub fn LoginAccount() -> Element {
    ...
    async fn client_login_account(event: Event<FormData>, mut error_sig: Signal<Option<String>>) -> () {
        let values = event.values();
        ...
        let (account_id, session_token) = match login_account(
            login.to_owned(),
        ...
        div {
            ...
            div {
                ...
                div {
                    ...
                    form {
                        onsubmit: move |event| client_login_account(event, error),
                        p {
                            margin: 0,
                            margin_bottom: "8px",
                            "Username or email "
